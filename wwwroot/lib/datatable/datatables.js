...
(function( factory ) {
	...
	function _fnMacros ( settings, str, entries )
	{
		...
		return str.
			...
			replace(/_ENTRIES_/g, settings.api.i18n('ورودی', '', entries) ).
			replace(/_ENTRIES-MAX_/g, settings.api.i18n('ورودی', '', max) ).
			replace(/_ENTRIES-TOTAL_/g, settings.api.i18n('ورودی', '', vis) );
	}
